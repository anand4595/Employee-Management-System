...
<body>
	...
	<nav class="bg-white py-2 md:py-4">
		<div class="container px-4 mx-auto md:flex md:items-center">
			...
			<div
				...
				<a href="/login"
					class="p-2 lg:px-4 md:mx-2 text-white rounded bg-indigo-600">Admin/Emp
	...
	<div class="conatiner p-3">
		<div class="row">
			...
			style="width: 13%; margin-left: 43%; margin-top:1%;">Login Page</h1>
						
						<% if (request.getAttribute("message") != null) {%>
							<p class="red-text" style="margin-top:1%;"><%=request.getAttribute("message")%></p>
						<%} %>
					</div>
					<div class="card-body">
						<form action="/auth/login" method="post">
							...
							<button class="bg-indigo-600 text-white py-2 px-6 rounded-full text-xl mt-6" style="margin-top:-3%;">Login</button>
						</form>
					</div>
				</div>
			</div>
