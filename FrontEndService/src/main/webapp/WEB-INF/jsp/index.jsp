  ...
  <div class="bg-indigo-100 py-6 md:py-12">
    <div class="container px-4 mx-auto">
      ...
      <div class="text-center max-w-2xl mx-auto">
        <h1 class="text-3xl md:text-4xl font-medium mb-2">Welcome to Employee Management Console Website.</h1>
        <button class="bg-indigo-600 text-white py-2 px-6 rounded-full text-xl mt-6">Get Started</button>
        <div class="mt-4">
          <img src="/image/img1.jpg" alt="mockup" class="d-block max-w-full rounded shadow-md">
        </div>
      </div>
